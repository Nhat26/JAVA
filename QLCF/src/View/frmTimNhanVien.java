 ...
 * @author THE LUC
 */
public class frmTimNhanVien extends javax.swing.JFrame {
    ...
    private void showAllNhanVien() {
        ...
        for (NhanVien nv : nvDAO.listNhanVien()){
            Object dataRow[] = new Object[6];
            dataRow[0] = nv.getMaNV();
            dataRow[1] = nv.getTenNV();
            dataRow[2] = nv.getGioiTinh()?"Nam":"Nữ";
            dataRow[3] = nv.getSDT();
            dataRow[4] = nv.getChucVu();
            dataRow[5] = nv.getNgayVaoLam();
    ...
    private void displayNhanVien() {
        tableModel.setRowCount(0);
        for (NhanVien nv : nvDAO.timListNhanVien(find)){
            Object dataRow[] = new Object[6];
            dataRow[0] = nv.getMaNV();
            dataRow[1] = nv.getTenNV();
            dataRow[2] = nv.getGioiTinh()?"Nam":"Nữ";
...
//         TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTimNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
