...
public class frmThemTaiKhoan extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (TaiKhoanSave != null) 
        {
            ...
            if (TaiKhoanDAO.getInstance().Update(TaiKhoanSave, txtPass.getText(), txtLoaiTK.getText(), txtMaNV.getText())) 
            {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        if (TaiKhoanSave != null) {
            if (TaiKhoanDAO.getInstance().Delete(TaiKhoanSave)) {
                LoadTable();
                TaiKhoanSave = null;
                txtMaNV.setText("");
                txtUsername.setText("");
